...
public class Payment {
    ...
    public Payment(ReservationRepository reservationRepository, FlightRepository flightRepository) {
    ...
    public String paymentPage(Model model) throws JsonProcessingException {
        ...
        String apiUrl2 = "http://localhost:8070/api/v1/ports/selectPorts"; // Update with the actual URL
